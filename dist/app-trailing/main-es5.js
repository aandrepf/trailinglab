...
var AcessoComponent = /** @class */ (function () {
    function AcessoComponent(toastr) {
        this.toastr = toastr;
        this.cadastro = false;
    }
...
var CadastroComponent = /** @class */ (function () {
    function CadastroComponent(_auth, toastr) {
        this._auth = _auth;
        this.toastr = toastr;
    ...
    CadastroComponent.prototype.exibirPainelLogin = function (msg) {
        this.exibirPainel.emit({ local: 'login', message: msg });
    };
    CadastroComponent.prototype.cadastrarUsuario = function () {
        var _this = this;
        var usuario = new _usuario_model__WEBPACK_IMPORTED_MODULE_5__["UserTrader"]();
        ...
        this._auth.cadastrarUsuario(usuario)
            ...
            if (dados.retCode === 0) {
                _this.exibirPainelLogin(dados.retMsg);
            }
            else {
                _this.toastr.error(dados.retMsg, 'Ops!');
            }
...
var AutenticacaoGuard = /** @class */ (function () {
    function AutenticacaoGuard(_auth) {
        this._auth = _auth;
    }
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.cadastrarUsuario = function (usuario) {
        var url = "http://mynetsurvey.com/api/auth/SignUp";
    ...
    AuthService.prototype.autenticar = function (email, senha) {
        var _this = this;
        var url = "http://mynetsurvey.com/api/auth/SignIn";
        var body = JSON.stringify({ Email: email, Password: senha });
        console.log('dados login', body);
        return this.http.post(url, body, httpOptions).toPromise()
            .then(function (res) {
            console.log('LOGIN:', res);
            _this.token_id = res.consumerKey;
...
var ConfirmarCadastroComponent = /** @class */ (function () {
    function ConfirmarCadastroComponent() {
    }
    ConfirmarCadastroComponent.prototype.ngOnInit = function () {
    };
    ...
    return ConfirmarCadastroComponent;
}());
